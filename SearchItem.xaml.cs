...
namespace Sierra_Romeo
{
    ...
    public partial class SearchItem : Window
    {
        ...
        private static readonly Uri endpoint = new Uri(System.Configuration.ConfigurationManager.AppSettings["pbsserveEndpoint"] + "/v1/item");
        public string PrescriberNumber;

        private CancellationTokenSource cancellationToken = null;

        public PBSItem CurrentItem;
        ...
        private async Task<List<PBSItem>> GetSearchResultsAsync(string query, CancellationToken cancellationToken)
        {
            ...
            var results = JsonSerializer.Deserialize<PBSItemSearchResults>(responseString, serializeOptions);
        ...
        private void OK_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                CurrentItem = (PBSItem)resultsList.SelectedItem;
                DialogResult = true;
            }
        }
